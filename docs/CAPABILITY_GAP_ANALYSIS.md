...
This project's UDR (`nfs/udr/src/main.cpp`) implements 19 real resource endpoints: AMF 3GPP-access
...
ADR's own real, deliberate design). What's covered is solid; the real gap is breadth -- roughly 19
...
of ADR-0103, now 19 as of ADR-0104 -- see below).
...
-- taking UDR from 18 to 19 of free5GC's ~42+ real resource types. Influence Data (AF traffic-steering, needed once NEF
