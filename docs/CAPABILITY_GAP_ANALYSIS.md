...
This project's UDR (`nfs/udr/src/main.cpp`) implements 61 real resource endpoints (60 real
...
PUT, webhook delivery deliberately not built),
...
ADR-0147, 59 as of ADR-0148, now 60 as of ADR-0149 -- see below). This is well past free5GC's own
~42+ figure for real
...
| UDR | ~2.5-10x | Resource-type breadth (60 of 42+ real TS 29.504 resources closed, past parity -- remainder of `group-data`, bare `/subscription-data/{ueId}`, `sdm-subscriptions`, real webhook delivery, and several genuinely-blocked/nested resources remain, see UDR section above) |
