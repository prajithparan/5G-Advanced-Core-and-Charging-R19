...
| NEF | Not yet swept against free5GC/open5GS source (built after this table, ADR-0185, not part of the original comparison pass) | 5 of 14 real Nnef YAML files built (`Nnef_PFDmanagement` ADR-0185; `Nnef_SMService`, `Nnef_UEId`, `Nnef_DNAIMapping`, `Nnef_EASDeployment` ADR-0207); 9 remain unbuilt (`Nnef_EventExposure`, `Nnef_TrafficInfluenceData`, `Nnef_SMContext`, `Nnef_Authentication`, `Nnef_ECSAddress`, `Nnef_Inference`/`Training`/`VFLInference`/`VFLTraining`) -- see ADR-0207 |
...
| NEF | ~~`Nnef_SMService`, `Nnef_UEId`, `Nnef_DNAIMapping`, `Nnef_EASDeployment`~~ CLOSED, ADR-0207 (first slice of 13) -- remaining: `Nnef_SMContext`, `Nnef_ECSAddress`, `Nnef_EventExposure`, `Nnef_Inference`, `Nnef_TrafficInfluenceData`, `Nnef_Training`, `Nnef_VFLInference`, `Nnef_VFLTraining`, `Nnef_Authentication` (9 files) |
