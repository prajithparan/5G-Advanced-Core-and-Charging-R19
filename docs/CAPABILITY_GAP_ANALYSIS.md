...
This project's UDR (`nfs/udr/src/main.cpp`) implements 62 real resource endpoints (61 real
...
correcting ADR-0122's original bundled deferral of both resources),
...
ADR-0147, 59 as of ADR-0148, 60 as of ADR-0149, now 61 as of ADR-0151 (ADR-0150 was a CHF-only CI
fix, no UDR resource change) -- see below). This is well past free5GC's own ~42+ figure for real
...
| UDR | ~2.5-10x | Resource-type breadth (61 of 42+ real TS 29.504 resources closed, past parity -- remainder of `group-data`, bare `/subscription-data/{ueId}`, both subscription resources' nested sub-collections, real webhook delivery, and several genuinely-blocked resources remain, see UDR section above) |
