...
This project's UDR (`nfs/udr/src/main.cpp`) implements 30 real resource endpoints: AMF 3GPP-access
...
ADR's own real, deliberate design). What's covered is solid; the real gap is breadth -- roughly 30
...
ADR-0113, 29 as of ADR-0114, now 30 as of ADR-0115 -- see below).
