...
This project's UDR (`nfs/udr/src/main.cpp`) implements 23 real resource endpoints: AMF 3GPP-access
...
ADR's own real, deliberate design). What's covered is solid; the real gap is breadth -- roughly 23
...
of ADR-0103, 19 as of ADR-0104, 20 as of ADR-0105, 21 as of ADR-0106, 22 as of ADR-0107, now 23 as
of ADR-0108 -- see below).
