...
This project's UDR (`nfs/udr/src/main.cpp`) implements 40 real resource endpoints (39 real
...
`sm-data`, -- ADR-0106 -- `lcs-bca-data`, -- ADR-0125 -- `sms-mng-data`, and -- ADR-0126 -- `sms-data`), and the real nested `policy-data/ues/{ueId}/sm-data` resource from ADR-0072
...
ADR's own real, deliberate design). What's covered is solid; the real gap is breadth -- roughly 39
...
ADR-0125, now 39 as of ADR-0126 -- see below).
