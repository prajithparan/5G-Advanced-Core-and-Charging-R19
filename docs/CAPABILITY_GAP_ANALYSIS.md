...
This project's UDR (`nfs/udr/src/main.cpp`) implements 27 real resource endpoints: AMF 3GPP-access
...
ADR's own real, deliberate design). What's covered is solid; the real gap is breadth -- roughly 27
...
ADR-0108, 24 as of ADR-0109, 25 as of ADR-0110, 26 as of ADR-0111, now 27 as of ADR-0112 -- see
below).
...
taking UDR from 26 to 27 of free5GC's ~42+ real resource types.
