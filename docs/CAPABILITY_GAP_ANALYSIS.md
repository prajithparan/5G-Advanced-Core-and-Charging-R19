...
`mbs-session-pol-data`, wiring the group-data `ee-subscriptions` family -- the last real candidate
batch unblocked by ADR-0176 -- to real `onDataChange` delivery, and others), not chasing a
shrinking
comparison count.
