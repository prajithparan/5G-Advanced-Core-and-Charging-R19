...
persistence, now 18 of free5GC's ~42+ real TS 29.504 resources including AMF non-3GPP-access
...
Coverage Restriction Data (ADR-0102, real GET-only, seeded at startup), and LCS Privacy
Subscription Data (ADR-0103, same GET-only seeded shape)), and UPF (task #107
...
`PATH_SWITCH_REQ`, the remaining ~24 of UDR's ~42+ real TS 29.504 resources (8 more now closed —
...
Coverage Restriction Data (ADR-0102), and LCS Privacy Subscription Data (ADR-0103), 18 of ~42+ total), ProSe's
PAnF-dependent
