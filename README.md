...
persistence, now 21 of free5GC's ~42+ real TS 29.504 resources including AMF non-3GPP-access
...
same shape), LCS Mobile Originated Subscription Data (ADR-0105, same shape), and LCS Broadcast
Assistance Data (ADR-0106, added as a 4th column on the existing provisioned-data group)), and UPF (task #107
...
`PATH_SWITCH_REQ`, the remaining ~21 of UDR's ~42+ real TS 29.504 resources (11 more now closed —
...
Subscription Data (ADR-0104), LCS Mobile Originated Subscription Data (ADR-0105), and LCS
Broadcast Assistance Data (ADR-0106), 21 of ~42+ total), ProSe's
PAnF-dependent
