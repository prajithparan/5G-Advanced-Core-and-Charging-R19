...
persistence, now 25 of free5GC's ~42+ real TS 29.504 resources including AMF non-3GPP-access
...
sibling collection GET, composite (ueId, afInstanceId) key), and individual Shared Data
(ADR-0110, the first UDR resource genuinely not keyed per-UE)), and UPF (task #107
...
`PATH_SWITCH_REQ`, the remaining ~17 of UDR's ~42+ real TS 29.504 resources (15 more now closed —
...
pp-data-store (ADR-0109), and individual Shared Data (ADR-0110), 25 of ~42+ total), ProSe's
PAnF-dependent
