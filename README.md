...
persistence, now 22 of free5GC's ~42+ real TS 29.504 resources including AMF non-3GPP-access
...
Assistance Data (ADR-0106, added as a 4th column on the existing provisioned-data group), and
Parameter Provision (Document) (ADR-0107, real GET+PATCH RFC 6902, upsert-capable)), and UPF (task #107
...
`PATH_SWITCH_REQ`, the remaining ~20 of UDR's ~42+ real TS 29.504 resources (12 more now closed —
...
Broadcast Assistance Data (ADR-0106), and Parameter Provision (Document) (ADR-0107), 22 of ~42+ total), ProSe's
PAnF-dependent
