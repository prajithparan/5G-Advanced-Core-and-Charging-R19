...
persistence, now 28 of free5GC's ~42+ real TS 29.504 resources including AMF non-3GPP-access
...
Data (Document) (ADR-0112, real GET-only, seeded at startup), and UE Policy Set (ADR-0113, real
GET+PUT+PATCH combining create-or-replace and RFC 7396 merge-patch)), and UPF (task #107
...
`PATH_SWITCH_REQ`, the remaining ~14 of UDR's ~42+ real TS 29.504 resources (18 more now closed —
...
Container (Document) (ADR-0111), Event Exposure Data (Document) (ADR-0112), and UE Policy Set
(ADR-0113), 28 of ~42+ total), ProSe's
PAnF-dependent
